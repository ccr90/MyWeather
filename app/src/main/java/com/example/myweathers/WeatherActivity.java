...
public class WeatherActivity extends AppCompatActivity {
    ...
    private void init() {
        weatherLayout = findViewById(R.id.weather_sv);
    ...
    private void loadBingPic() {
        ...
        HttpUtil.sendOkHttpRequest(requestBingPic, new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                Toast.makeText(WeatherActivity.this,"加载背景失败，干你！",Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                editor.putString(weather_id,bingPic);
                editor.apply();
        ...
        HttpUtil.sendOkHttpRequest(weatherUrl, new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(WeatherActivity.this, "获取天气信息failure，干你！", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
            }
